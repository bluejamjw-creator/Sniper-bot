...
// Adds regime-reject diagnostic logging so watchlist-vs-trades
// gaps (e.g. neutral BTC blocking the hard regime gate) are
// verifiable with real numbers. Plus the weekend MARKET UPDATE
// fix, the crypto pool dynamic fix, watchlist_history, the
// false_breakout gate, the V94 reversion, and all prior fixes.
// ================================================================
