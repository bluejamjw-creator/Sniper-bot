...
console.log("🚀 SNIPER V65 PRODUCTION STARTING...");
...
function isLSEOpen() {
  ...
  return (
    minuteOfDay >= 420 &&  // 07:00 UTC = 08:00 BST (LSE open)
    minuteOfDay < 950      // 15:50 UTC = 16:50 BST (LSE close)
  );
...
function analyse(
  ...
  const nearEMA20 =
    market === "CRYPTO"
      ? ema20 * 1.06   // crypto trends stay 4-6% above EMA20
      : ema20 * 1.035; // stocks tighter — 3.5% buffer
  ...
  // Old: 3 consecutive green candles (too aggressive — kills healthy trends)
  // New: 4-candle move > 8% (only blocks true overextension)
  // ============================================================
...
`🚀 SNIPER V65 PRODUCTION LIVE

✅ market hours fixed: LSE 08:00 BST / US 14:30 BST
✅ nearEMA20 market-aware: crypto 6% / stocks 3.5%
✅ recentRun % based: blocks >8% in 4 candles only
✅ extension limit: crypto 14% / stocks 9%
✅ avgVol excludes current candle (cleaner spikes)
✅ dynamic TP: entry + risk*2.2R (was fixed 6%)
✅ stock min vol loosened to 0.85x
✅ REJECTION LOGGING active — see Railway logs
✅ 4 setup types: CONTINUATION / RECLAIM / BREAKOUT / PARABOLIC
✅ crypto 21 pairs / US 50 stocks / LSE 18 names
✅ 5 min scans / MAX_SIGNALS 12

🎯 V65 — diagnostic + filter-optimised engine active`
