...
const MIN_US_MOMENTUM        = 0.005; // 0.5% per 1h candle — was 1.5%, too high for regular session
const MIN_PULLBACK_MOM_US    = 0.003; // pullback entries need even less momentum
