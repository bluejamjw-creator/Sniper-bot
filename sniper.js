...
console.log("🚀 SNIPER V63 PRODUCTION STARTING...");
...
// V63: init from live market state so restarts don't miss open alerts
let usMarketState = isUSMarketOpen();
let lseMarketState = isLSEOpen();
...
`🚀 SNIPER V63 PRODUCTION LIVE

✅ improved reclaim logic (pullback/bounce/drift)
✅ stock vol loosened: breakout 1.03x / reclaim 1.00x
✅ breakout lookback shortened 15 → 10 candles
✅ market open alerts fixed (live state init)
✅ 5 min scan intervals (was 10 min)
✅ MAX_SIGNALS increased 8 → 12
✅ stocks on 1h candles / LSE on daily
✅ tiered crypto watchlist
✅ setup-aware entries: LIMIT / STOP BUY
✅ anti-chase protection intact
✅ crypto + US + LSE

🎯 V63 — signal-optimised momentum engine active`
