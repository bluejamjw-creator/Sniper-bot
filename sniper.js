...
// Includes: combinedScore fix, TOP_HIGHBETA_5M fix, duplicate
// isFirstPullbackContinuation flagged, Structure Quality Engine
// (STRUCTURE_QUALITY_MODE="log"), structure-grade watchlist
// gating, BEAR-regime log fix, and end-of-day report routed
// to private (Bluejam) instead of the public channel.
// ================================================================
