...
console.log("🚀 SNIPER V60 PRODUCTION STARTING...");
...
// ================================================================
// V60 ANTI-CHASE UPGRADES
// ================================================================

// Tightened from 0.12 → 0.09
const EXTENSION_HARD_LIMIT = 0.09;

// Raised from 0.08 → 0.07 (limit entry triggers earlier)
const EXTENSION_LIMIT_ENTRY = 0.07;

// Raised from 1.15 → 1.20 (stricter breakout volume confirmation)
...
function analyse(
  ...
  // V60: raised confirmation volume from 1.15 → 1.20
  ...
  // ============================================================
  // V60: LIMIT ENTRY TRIGGER — adjusted 0.08 → 0.07
  // ============================================================

  if (
    extension > EXTENSION_LIMIT_ENTRY
  ) {
