...
async function refreshDynamicPools() {
  ...
  // V84: cap at 25 symbols to stay within API limits
  ...
  console.log(`📊 API usage today — TwelveData: ${apiUsage.twelvedata}/${API_LIMITS.twelvedata}, AlphaVantage: ${apiUsage.alphavantage}/${API_LIMITS.alphavantage}`);
