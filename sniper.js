...
// Adds: watchlist_history persistence (Supabase) + weekly
// watchlist summary table, attached ONLY to the Wednesday
// midweek Bluejam check-in. Plus the false_breakout structure
// gate, V94 analyse()/intel reversion, and all prior fixes.
// ================================================================
