...
// SMART WATCHLIST + READY SIGNALS
// TP / SL TRACKING
// COMPACT ALERTS
// ================================================================

console.log("🚀 SNIPER V41 STARTING...");
...
const STOCK_COOLDOWN_HOURS = 0.5;

// FILTERS

const CRYPTO_MIN_MOMENTUM = 0.003;
const CRYPTO_MIN_VOL = 1.08;

const STOCK_MIN_MOMENTUM = 0.005;
const STOCK_MIN_VOL = 1.01;

const MAX_MOMENTUM = 0.30;

const BREAKOUT_BUFFER = 0.997;
...
🎯 ${formatPrice(t.entry, t.currency)}
