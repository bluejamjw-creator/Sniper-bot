...
console.log("🚀 SNIPER V30 STARTING...");
...
function ensureFiles() {
  ...
  if (!fs.existsSync(FILES.summary)) fs.writeFileSync(FILES.summary, "{}");
}
...
app.get("/", (_req, res) => res.send("SNIPER V30 RUNNING 🚀"));
app.get("/health", (_req, res) => res.json({
  status: "ok",
  btcTrend,
  stockSession: stockAllowed() ? (isUsRegularSessionNow() ? "regular" : "premarket") : "off",
  time: nowIso()
}));
