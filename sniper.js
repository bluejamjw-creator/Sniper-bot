...
async function sendEndOfDayReport() {
  ...
  parts.push(`——————————`);
  parts.push(`⚠️ <i>Educational market commentary only · Not personalised investment advice · Not a recommendation to buy or sell · 🎯 Sniper by @baretradesignals</i>`);
...
async function sendWeeklyAudit() {
  ...
  const parts = [
    ...
    ``,
    `——————————`,
    `⚠️ <i>Educational market commentary only · Not personalised investment advice · Not a recommendation to buy or sell · 🎯 Sniper by @baretradesignals</i>`,
  ];
...
const LEADERBOARD_DISCLAIMER = `⚠️ <i>Educational market commentary only · Not personalised investment advice · Not a recommendation to buy or sell · 🎯 Sniper by @baretradesignals</i>`;
...
async function safeCycle() {
  ...
  try {
    ...
    if (nowProtecting && !macroProtecting && alertCooldown) {
      ...
      lines2.push(``);
      lines2.push(`——————————`);
      lines2.push(`⚠️ <i>Educational market commentary only · Not personalised investment advice · Not a recommendation to buy or sell · 🎯 Sniper by @baretradesignals</i>`);
