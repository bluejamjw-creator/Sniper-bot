// ================================================================
// SNIPER V86
// + Exceptional crypto override lowered: 1.5% candle + 1.8x vol
//   catches real altcoin moves even when BTC is ranging
// + Rejection logging added so we can see exactly why signals fail
// + All V85 logic preserved
// ================================================================
...
app.listen(PORT, "0.0.0.0", async () => {
  ...
  await send(
    "\uD83D\uDE80\uD83D\uDD25 SNIPER V85 LIVE\n" +
    "Signal alerts only \u2022 No noise \u2022 Money machine mode\n" +
    "Next message will be a trade signal or a close update."
  );
