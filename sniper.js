...
// NEW LIVE PATHWAY: GRIND PATH. Evidence-backed (+0.013R on 116
// real, precise-window samples vs -0.17 to -0.29R for the general
// rejected population). Grind-eligible candidates that fail the
// 15m impulse gate now continue into the SAME unchanged downstream
// pipeline (structure/setup/regime/No Regret) instead of being cut
// off immediately -- momentum gate itself untouched for all normal
// signals. Requires stricter RR (2.0 vs 1.5) given the thin edge.
// Clearly labeled in every alert (viaGrindPath flag, visible
// message tag). Math re-verified before building. Plus all prior
// session fixes.
// ================================================================
