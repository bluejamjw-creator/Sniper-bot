// ================================================================
// SNIPER V34
// SMART MOMENTUM BREAKOUT SCANNER
// Crypto + US Stocks + LSE
// READY NOW / WATCHLIST SYSTEM
// A* / A / B GRADING
// ================================================================

console.log("🚀 SNIPER V36 STARTING...");
...
🎯 Entry:
${s.currency}${s.entry.toFixed(4)}

🛑 Stop Loss:
${s.currency}${s.sl.toFixed(4)}

💰 Take Profit:
${s.currency}${s.tp.toFixed(4)}
