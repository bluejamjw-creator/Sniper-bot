...
// Crypto momentum floor lowered 0.003 -> 0.0025, evidence-based
// (BTC/STRK/LINK/ETH peaked 0.002981-0.002999 all week, missing
// the old floor by fractions). Flat value, no regime conditional.
// Watch the next week -- if ELITE/GOOD signals return on these
// names, diagnosis confirmed; if not, problem is elsewhere. Plus
// all prior session fixes.
// ================================================================
