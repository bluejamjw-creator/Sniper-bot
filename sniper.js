...
// NEW: grade now persisted in trades. Two new Discord channels
// wired: DISCORD_WEBHOOK_WATCHLIST (watchlist + WATCHLIST BUILDING
// alerts) and DISCORD_WEBHOOK_PREMIUM (A* grade fires get a richer
// duplicate post -- Hunter Score breakdown, structure quality,
// peak-score context -- IN ADDITION to the normal #signals post,
// never instead of it). Set both env vars in Railway when the
// Discord channels exist. Plus all prior session fixes.
// ================================================================
...
// ── Thresholds ───────────────────────────────────────────────────
// Crypto 15-min
const CRYPTO_15M_MIN_MOMENTUM    = 0.003; // V94 baseline (was 0.002 -- drift, not a deliberate V94 reversion choice)
