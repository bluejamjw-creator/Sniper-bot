...
// Fixes no_regret visibility gap -- that stage never incremented
// the counter the daily block stats report reads from, so it was
// invisible there no matter how many real candidates it killed.
// Now shows in both the daily table and the WHAT TO ACTUALLY TWEAK
// insight box. Plus the No Regret RR/chase/volume fix and all
// prior session fixes.
// ================================================================
