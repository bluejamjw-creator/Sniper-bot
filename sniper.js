...
// MAJOR FIX: sniper_signal_decisions had 168,000+ rows, ALL
// decision=REJECT -- zero record of any candidate that passed
// every gate. Now logs a PASS entry using the rich schema that
// already existed in Supabase but was never populated (score,
// setup_score, execution_score, rr, risk_pct, atr, entry/sl/tp,
// grade). Fire-and-forget, never blocks the real signal. Plus
// all prior session fixes including GRIND diagnostics and the
// Hunter integration (off by default).
// ================================================================
