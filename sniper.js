...
server = app.listen(PORT, "0.0.0.0", async () => {
  log(`🚀 SNIPER V99 on port ${PORT}`);
  await safeRun("bootTelegram", () => sendPrivate(lines([
    "🚀 SNIPER V99 LIVE -- FOUR MODULE ENGINE",
    "",
    "MODULE 1 -- HEAT SCORE SYSTEM:",
    "✅ Intel +20, watchlist +15, crypto-intel +20, signal +30",
    "✅ 8hr linear decay, HOT threshold = 80pts",
    "✅ Heat Index posted to channel hourly",
    "",
    "MODULE 2 -- LEADER MODE:",
    "✅ Heat >= 80 + Vol >= 3x + Mom >= 5% = LEADER",
    "✅ Breakout distance relaxed 50%, +10 score bonus",
    "✅ HOT LEADER tag shown to subscribers",
    "",
    "MODULE 3 -- TRADE STATE ENGINE:",
    "✅ HEALTHY_CONSOLIDATION → hold (the ARB/SOL fix)",
    "✅ FAILED_BREAKOUT → exit after 1hr",
    "✅ TREND_FAILURE → exit immediately",
    "✅ 12hr absolute hard cap for crypto (up from 4hr)",
    "",
    "MODULE 4 -- NO REGRET ENGINE:",
    "✅ 5 checks: R:R, momentum, better candidate, heat, volume",
    "",
    "MODULE 5 -- OPPORTUNITY RANKING:",
    "✅ Composite rank replaces raw score ordering",
    "",
