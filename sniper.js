...
async function analyse(asset, candles, market, prefetchedQqqMom = null) {
  ...
  if (grade === "B") {
    ...
    reject("score_floor", asset, market, { qualityFlags: { gradeB: true }, rawScore: score, grade });
    return null;
  }
  ...
  const flagCount = [qualityFlags.rr, qualityFlags.riskPct, qualityFlags.expansion, qualityFlags.resistance]
