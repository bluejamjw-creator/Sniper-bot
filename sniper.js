...
// Removed the MARKET UPDATE / SCANNER RESUMING alert pair --
// fired repeatedly with identical generic text since the choppy-
// market condition it watches is designed to oscillate. Plus the
// V94 constant audit (MIN_RR/TARGET_R fix), accurate version
// banner, and all prior session fixes.
// ================================================================
