...
// Boot-log version banner now accurately describes the file:
// V94-baseline entry logic + V101 infrastructure. Includes the
// MIN_RR/TARGET_R fix to V94 real values (1.5, was drifted to
// 2.0), the trades.sentToChannel persistence fix, momentum
// column precision fix, and everything else from this session.
// ================================================================
