...
async function fetchUSData(symbol) {
  ...
  // Tighter 90 min window = credits reserved for the opening hour that matters most
  // Hard credit cap at 600 to always keep buffer
  const ukMins = getUkMinutes();
...
server = app.listen(PORT, "0.0.0.0", async () => {
  ...
  await safeRun("bootTelegram", () => sendPrivate(lines([
    ...
    "",
    "V95: TREND_RESUMPTION -- gap-day continuation for HIGH_BETA",
    "V95: Score floors lowered (US 76->72, HB 74->70)",
    "V95: US cooldown 4hrs->2hrs",
    "V95: Intel movers bonus for confirmed stocks",
    "TwelveData: active window only (14:00-16:00 UK)",
