// ================================================================
// SNIPER V92 -- MOMENTUM MATURITY ENGINE
// ----------------------------------------------------------------
// V92 changes from V91:
//   - MAX_CONCURRENT_REQUESTS reduced to 1 (fixes TwelveData 8/min overrun)
//   - Volume range proxy fix for HIGH_BETA zero-volume Yahoo data
//   - Diagnostic block logs (extension / momentumCap / score) -- fire only when blocking
//   - MIN_GLOBAL_SCORE 74->70, MIN_CRYPTO_SCORE 76->72
//   - CRYPTO_15M_MAX_MOMENTUM 0.06->0.09
//   - APPROVED_CRYPTO_PREFIXES -- filters injection noise (PARTI, CFX, ELF etc blocked)
//   - Dynamic injection: volume threshold 500k->5M, max injections 5->3
//   - Narrative alert crypto filtered to approved list only
// ================================================================
...
console.log("🚀 SNIPER V92 STARTING...");
...
server = app.listen(PORT, "0.0.0.0", async () => {
  log(`🚀 SNIPER V92 on port ${PORT}`);
  await safeRun("bootTelegram", () => sendPrivate(lines([
    "\uD83D\uDE80 SNIPER V92 LIVE -- MOMENTUM MATURITY ENGINE",
    "",
    ...
    "TwelveData: serial requests (1/min cap respected)",
