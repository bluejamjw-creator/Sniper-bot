...
// WATCHLIST BUILDING alert now shows real computed content --
// actual EMA-relationship description, real 24h/intraday price
// change, and real heat score -- instead of a hardcoded 2-option
// guess. updateSniperRoster made async to support the candle fetch
// this needs. Plus all prior session fixes.
// ================================================================
