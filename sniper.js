...
async function analyse(asset, candles, market) {
  ...
  // V94: limit set at EMA20 * 1.008 -- slightly above EMA for better fill rate
  // EMA * 1.002 was too tight, price often bounces before touching exact EMA
  // 0.8% above EMA still gets a good pullback entry while actually filling
  const entry     = setupType==="PULLBACK_CONTINUATION" ? ema20*1.008 : last;
