...
async function sendWatchlistAlert(alerts, trades) {
  ...
  parts.push(``, `\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014`, `\u26A0\uFE0F <i>Educational only · Not financial advice · Not FCA or SEC regulated · @baretradesignals</i>`);
...
// V97: switched from feed=iex to feed=sip with 16-min delayed end
    ...
    const { data } = await retry(() =>
      axios.get(`https://data.alpaca.markets/v2/stocks/${symbol}/bars`, {
        params: {
          ...
          limit: 1000,       // V97: raised from 60 -- page size not total limit
          adjustment: "raw",
          feed: "sip"
        },
        headers: {
...
function buildSignalMessage(signal, size) {
  ...
  return lines([
    `\uD83D\uDEA8 ${gradeEmoji(signal.grade)} <b>${escapeHtml(signal.grade)} SETUP DETECTED</b>${ntag}`,
    ``,
    ...
    ``,
    isMarket      ? `\u26A1 <b>Entry zone</b> ~${escapeHtml(formatPrice(signal.entry, signal.market))} (market price)`
    : isConditional ? `\uD83D\uDFE1 <b>Breakout level</b> ${escapeHtml(formatPrice(signal.entry, signal.market))} (if price breaks above)`
    : `\uD83D\uDCB0 <b>Entry zone</b> ${escapeHtml(formatPrice(signal.entry, signal.market))} (limit area)`,
    ...
    ``,
    `\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014`,
    `\u26A0\uFE0F <i>Educational only · Not financial advice · Not FCA or SEC regulated</i>`,
...
function buildCloseMessage(trade, reason, closePrice) {
  ...
  if (isWin)  parts.push(``, `\uD83C\uDF7E <b>Target reached.</b>${rVal?` Algorithm captured ${rVal}x the risk.`:""} Setup played out as the scanner identified.`);
  ...
  if (isWin || isLoss) {
    parts.push(``, `\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014`, `\u26A0\uFE0F <i>Educational only · Not financial advice · Not FCA or SEC regulated</i>`, `\uD83D\uDCF8 <i>Analysis by @baretradesignals</i>`);
  }
  return lines(parts);
}
