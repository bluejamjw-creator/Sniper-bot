...
// NEW: Top Performers -- day/week/month/YTD top 5 for US stocks
// and crypto, added into Intel once per day. Stock pool expanded
// 25->60 with new sector breadth (Financials, Healthcare, Consumer,
// Industrials, Utilities, Communications, Materials) now that Hunter
// is crypto-only. Reused/extended existing daily-candle fetch
// (with Bybit fallback) rather than duplicating it -- caught and
// fixed a real nesting bug along the way. Plus all prior fixes.
// ================================================================
