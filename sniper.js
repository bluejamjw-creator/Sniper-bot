...
// FIXED: real timestamps added to Binance/Alpaca/Polygon candle
// mappings (were being discarded despite being in the raw API
// response). The 24h rejection_outcomes walk now filters to the
// exact [rejected_at, +24h] window when timestamps are available,
// honestly flagged via new precise_window column when it must
// fall back to unfiltered depth (paths still missing timestamps).
