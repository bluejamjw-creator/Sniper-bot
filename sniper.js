// ================================================================
// SNIPER V93 -- MOMENTUM MATURITY ENGINE
// ----------------------------------------------------------------
// V93 changes from V92:
//   - Morning Movers Briefing: daily 08:00 UK alert showing HIGH_BETA
//     names already moving 3%+ before US open (Finnhub quotes)
//     Only fires for stocks in HIGH_BETA_STOCKS pool -- no penny stocks
// ================================================================
...
console.log("🚀 SNIPER V93 STARTING...");
...
app.get("/",       (_req, res) => res.status(200).send("SNIPER V93 alive"));
...
server = app.listen(PORT, "0.0.0.0", async () => {
  log(`🚀 SNIPER V93 on port ${PORT}`);
  await safeRun("bootTelegram", () => sendPrivate(lines([
    "\uD83D\uDE80 SNIPER V93 LIVE -- MOMENTUM MATURITY ENGINE",
    "",
    ...
    "Crypto noise filter: approved pairs only",
    "TwelveData: active windows only (07:30-11:30 + 14:00-21:00 UK)",
