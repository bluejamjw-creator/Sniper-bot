// ================================================================
// SNIPER V81
// + Fixed US market hours (13:30–21:00 UTC covers BST correctly)
// + Fixed LSE market hours (07:00–15:30 UTC during BST)
// + All V80 Hunter Edition logic preserved
// ================================================================

console.log("🚀 SNIPER V81 STARTING...");
...
app.get("/",       (_req, res) => res.status(200).send("SNIPER V81 alive"));
...
app.listen(PORT, "0.0.0.0", async () => {
  ...
  await send(
    "\uD83D\uDE80\uD83D\uDD25 SNIPER V81 LIVE\n" +
    "Market hours fixed \u2022 Dynamic pools \u2022 Narrative detection \u2022 Momentum Ignition active"
  );
