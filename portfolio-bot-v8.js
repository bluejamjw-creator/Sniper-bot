...
async function fireLeaderboardMessage(scan) {
  ...
  // Runs every leaderboard cycle — this is the primary research dataset.
  // FIX: assetType field was c.assetType but STATE.leaderboard fallback
  // candidates use c.type — coerce both. Also added explicit row-level
  // logging so silent failures are visible in Railway logs.
